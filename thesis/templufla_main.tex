...
\hypersetup{%
% Titulo
pdftitle={HalterCheck: avaliação experimental de um sistema embarcado com IMUs em halteres para detecção de erros na elevação lateral.},
% Autor
pdfauthor={Douglas Aquino Teixeira Mendes},
% Descrição
pdfsubject={},
% Palavras-Chave
pdfkeywords={}
...
\title{HalterCheck: avaliação experimental de um sistema embarcado com IMUs em halteres para detecção de erros na elevação lateral.}

% Subítulo do trabalho, em lígua vernácula
%\subtitle{Usando Latex! =)}

% Título do trabalho, em inglês
\engtitle{HalterCheck: experimental evaluation of an embedded system using IMUs in dumbbells for error detection in lateral raises.}
...
\bancaum{Prof. Me. Um}{UFM}
\bancadois{Prof. Dr. Dois}{FCO}
\bancatres{Profa. Dra. Três}{BELMIS}
\bancaquatro{Prof. Esp. IV}{UFO}

% Data da defesa
\defesa{01 de Dezembro de 2026}
...
% Epígrafe
\epigrafe{%
Que eu tenha serenidade para aceitar aquilo que não posso mudar,
coragem para transformar aquilo que está ao meu alcance
e sabedoria para distinguir uma coisa da outra.
\par
(Adaptado da Oração da Serenidade.)}
...
\include{secoes/trabalhos-relacionados}
\include{secoes/haltercheck}
\include{secoes/metodologia}
\include{secoes/resultados}
\include{secoes/discussao}
